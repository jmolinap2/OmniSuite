...
public abstract class OmniSuiteWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static OmniSuiteWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(OmniSuiteWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<OmniSuiteDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<OmniSuiteDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<OmniSuiteDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<OmniSuiteDbContext, Task<T>> func)
    {
        T result;
